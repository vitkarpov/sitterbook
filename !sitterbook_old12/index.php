...
-->
    ...
    <script type="text/javascript">
     ...
     $(document).on("click", ".add-city", function() {
            $(".select-city .add-city").before("<div class='wrap-sel'> <div class='sel seld-title'> <select name='city' class='city'> <option disabled='disabled' selected='selected'>Город</option> <div class='all-city'> <optgroup label='Выберите город'> <option value='1'>Москва</option> <option value='2'>Санкт-Петербург</option> <optgroup label='Московская область'> <option value='3'>Апрелевка</option> <option value='4'>Балашиха</option> <option value='5'>Бронницы</option> <option value='6'>Верея</option> <option value='7'>Видное</option> <option value='8'>Волоколамск</option> <option value='9'>Воскресенск</option> <option value='10'>Высоковск</option> <option value='11'>Дедовск</option> <option value='12'>Дзержинский</option> <option value='13'>Дмитров</option> <option value='14'>Долгопрудный</option> <option value='15'>Дрезна</option> <option value='16'>Домодедово</option> <option value='17'>Дубна</option> <option value='18'>Егорьевск</option> <option value='18'>Железнодорожный</option> <option value='19'>Жуковский</option> <option value='20'>Зарайск</option> <option value='21'>Зеленоград</option> </div> </select> </div> <!--Округи и карта МСК--><div class='count-sel-and-map count-sel-spb'><span>Выбрано 2 района</span><p><a name='modal' href='#dialog10'>Выбрать районы на карте</a></p></div><div class='county-maps'><div class='sel seld-old'> <span class='seld-old-title'>Округ</span> <div class='all-city'> <p>Выберите округ/а</p> <div class='checkbox'> <label> <input class='ch' type='checkbox' name='test' value='yes'/> <span></span> </label> <span class='lab'> Все округа </span> </div> <div class='checkbox'> <label> <input class='ch' type='checkbox' name='test' value='yes'/> <span></span> </label> <span class='lab'> СЗАО </span> </div> <div class='checkbox'> <label> <input class='ch' type='checkbox' name='test' value='yes'/> <span></span> </label> <span class='lab'> САО </span> </div> <div class='checkbox'> <label> <input class='ch' type='checkbox' name='test' value='yes'/> <span></span> </label> <span class='lab'> СВАО </span> </div> <div class='checkbox'> <label> <input class='ch' type='checkbox' name='test' value='yes'/> <span></span> </label> <span class='lab'> ЗАО </span> </div> <div class='checkbox'> <label> <input class='ch' type='checkbox' name='test' value='yes'/> <span></span> </label> <span class='lab'> ЦАО </span> </div> <div class='checkbox'> <label> <input class='ch' type='checkbox' name='test' value='yes'/> <span></span> </label> <span class='lab'> ВАО </span> </div>	<div class='checkbox'> <label> <input class='ch' type='checkbox' name='test' value='yes'/> <span></span> </label> <span class='lab'> ЮЗАО </span> </div>	<div class='checkbox'> <label> <input class='ch' type='checkbox' name='test' value='yes'/> <span></span> </label> <span class='lab'> ЮАО </span> </div>	<div class='checkbox'> <label> <input class='ch' type='checkbox' name='test' value='yes'/> <span></span> </label> <span class='lab'> ЮВАО </span> </div>	<div class='checkbox'> <label> <input class='ch' type='checkbox' name='test' value='yes'/> <span></span> </label> <span class='lab'> ЗелАО </span> </div>	<div class='checkbox'> <label> <input class='ch' type='checkbox' name='test' value='yes'/> <span></span> </label> <span class='lab'> НАО </span> </div> <div class='checkbox'> <label> <input class='ch' type='checkbox' name='test' value='yes'/> <span></span> </label> <span class='lab'> ТАО </span> </div> <div class='green-btn'>Ок</div> </div> </div><div class='count-sel-and-map'> <span>Выбрано 11 районов</span> <p><a name='modal' href='#dialog9' href='#'>Выбрать округа и районы на карте</a></p> </div> </div><div class='remove left'></div></div> </div><div class='clear'></div>");
            openModal();
         });
     ...
     $(document).on("click", ".add-city", function(){
            $(".city").parent(".sel").change(
                function(){
                var valOpt=$(this).find('option:selected').val();
                if(valOpt=="1")$(this).next().next(".county-maps").show("fast");
                else  $(this).next().next(".county-maps").hide("fast")
                });
            ...
            $(".city").parent(".sel").change(
                function(){
                var valOpt=$(this).find('option:selected').val();
                if(valOpt=="2")$(this).next(".count-sel-spb").show("fast");
                else  $(this).next(".count-sel-spb").hide("fast")
                });
					...
					<div class="work-map">
						...
						<div class="select-city">
							...
							<div class="sel seld-title">
                                <select name="city" class="city" id="parent-city">
