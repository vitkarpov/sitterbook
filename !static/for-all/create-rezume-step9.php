				...
				<div class="wrap">
					...
					<div class="work-map">
						...
						<div class="select-city">
							...
							<div class="count-sel-and-map count-sel-and-map3">
							...
							<div class="count-sel-and-map count-sel-and-map2">
								...
								<p><a name="modal" href="#dialog11" href="#">Выбрать районы на карте</a></p>
							</div>
							</div>
							...
							<div class="count-sel-and-map count-sel-and-map2">
								<p><a name="modal" href="#dialog12" href="#">Показать на карте</a></p>
							</div>
							</div>
				...
				<div class="wrapper">
					<div class="prompt">
						...
						<div class="block">
							...
							<p>Выберите все районы<br />где вы готовы работать</p>
						</div>
						<div class="block">
			...
			<div id="dialog9" class="window">
				...
				<div class="wrapper mapped">
					...
					<div class="right-map right-map2">
						<div class="bl">
							<p><a href="#">Округа и районы на схеме</a></p>
						</div>
						<div class="yamap">
							<script type="text/javascript" charset="utf-8" src="https://api-maps.yandex.ru/services/constructor/1.0/js/?sid=uW7Yy1W9blMveCAxRWIvz9QCcWpY82wY&width=615&height=670&lang=ru_RU&sourceType=constructor"></script>
						</div>
					</div>
				</div>
			</div>
		...
		<div id="boxes11">
			<div id="dialog11" class="window">
				...
				<div class="wrapper mapped">
					...
					<div class="right-map right-map2">
						<div class="bl">
							<p><a href="#">Районы на схеме</a></p>
						</div>
						<div class="yamap">
							<script type="text/javascript" charset="utf-8" src="https://api-maps.yandex.ru/services/constructor/1.0/js/?sid=IEcP9c6nmcTDzpyt6j2nRObOnYR1IE48&width=615&height=620&lang=ru_RU&sourceType=constructor"></script>
						</div>
					</div>
				</div>
			</div>
		...
		<div id="boxes12">
			<div id="dialog12" class="window">
				...
				<div class="wrapper mapped">
					...
					<div class="clear"></div>
					<div class="yamapp">
						<script type="text/javascript" charset="utf-8" src="https://api-maps.yandex.ru/services/constructor/1.0/js/?sid=lK6Lsw_oIh9_AQjZeN5GKl4JuA-pIAS8&width=890&height=500&lang=ru_RU&sourceType=constructor"></script>
					</div>
					<div class="btn">
						<a href="#">Ок</a>
					</div>
