				...
				<div class="wrap">
					...
					<div class="work-map">
						...
						<div class="wrap-sels">
							...
							<div class="select-city mbb">
								<p class="mb">Округ: <span>*</span></p>
								<div class="wrap-sel">
								<div class="sel sel2">
									<span>Выберите округ</span>
							...
							<div class="count-sel-and-map">
								<p>
									<a href="#dialog9" name="modal">Выбрать округ и район на карте</a>
								</p>
							</div>
							<div class="clear"></div>
			...
			<div id="dialog9" class="window">
				...
				<div class="wrapper mapped">
					...
					<div class="citys citys2 citys3">
						<div class="work">
							<div class="block-sel block-sel2">	
								<p>Выберите округ<br />и район Москвы</p>
								<div class="wrap-check">
								
									
									<div class="parent-check2">	
										<p>
											<span class="lab"><span class="plus"><img src="img/arrow-right.png" alt="" /></span> СЗАО</span>
										</p>
									...
									<div class="parent-check2">	
										<p>
											<span class="lab"><span class="plus"><img src="img/arrow-right.png" alt="" /></span> САО </span>
										</p>
										<div class="children-check">
											<div class="check check2">
												<p>
									...
									<div class="parent-check2">	
										<p>
											<span class="lab"><span class="plus"><img src="img/arrow-right.png" alt="" /></span> СВАО</span>
										</p>
										<div class="children-check">
											<div class="check check2">
												<p>
									...
									<div class="parent-check2">	
										<p>
											<span class="lab"><span class="plus"><img src="img/arrow-right.png" alt="" /></span> ЗАО</span>
										</p>
										<div class="children-check">
											<div class="check check2">
												<p>
									...
									<div class="parent-check2">	
										<p>
											<span class="lab"><span class="plus"><img src="img/arrow-right.png" alt="" /></span> ЦАО</span>
										</p>
										<div class="children-check">
											<div class="check check2">
												<p>
									...
									<div class="parent-check2">	
										<p>
											<span class="lab"><span class="plus"><img src="img/arrow-right.png" alt="" /></span> ВАО</span>
										</p>
										<div class="children-check">
											<div class="check check2">
												<p>
					...
					<div class="right-map">
						...
						<div class="yamap">
							<script type="text/javascript" charset="utf-8" src="https://api-maps.yandex.ru/services/constructor/1.0/js/?sid=uW7Yy1W9blMveCAxRWIvz9QCcWpY82wY&width=615&height=720&lang=ru_RU&sourceType=constructor"></script>
						</div>
					</div>
				</div>
			</div>
