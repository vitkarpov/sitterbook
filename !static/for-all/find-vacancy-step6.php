					...
					<div class="form-rezume">
						<form name="myform" action="#" method="post">
							<div class="work workadd">
								...
								<div class="gorod">
									<p class="gorod-city">Санкт-Петербург</p>
									...
									<p class="gorod-okrug">Районы</p>
									<div class="block-goroda">
										<span>Выборгский X</span>
										<span>Пушкинский X</span>
										<span>Кронштадский X</span>
									</div>
									<p class="select">Выбрано 2 района</p>
								</div>
								
								<div class="iconmap"><a class="addokrug" href="#">Выбрать районы на карте</a></div>
								<div><a class="clear" href="#">Очистить</a></div>
								...
								<div class="iconmap mt"><a class="addokrug" href="#">Показать на карте</a></div>
								
								
								<div><a class="clear" href="#">Очистить</a></div>
								
								
								<div class="work marg last">
									<div class="styled-select styled-select2">
										<select name="grajd">
											<option>Город</option>
											<option>Москва</option>
