			...
			<div id="dialog9" class="window">
				...
				<div class="wrapper mapped">
					...
					<div class="right-map">
						...
						<div class="yamap">
							<script type="text/javascript" charset="utf-8" src="https://api-maps.yandex.ru/services/constructor/1.0/js/?sid=IEcP9c6nmcTDzpyt6j2nRObOnYR1IE48&width=615&height=600&lang=ru_RU&sourceType=constructor"></script>
						</div>
					</div>
				</div>
			</div>
